...
public class SimulationResults extends JDialog implements ActionListener
{
    ...
    public SimulationResults(JFrame frame)
    {
         ...
         * layout.setAutoCreateContainerGaps(true); layout.setHorizontalGroup(
         * layout.createSequentialGroup() .addComponent(algoritme)
         * .addComponent(tijd) .addComponent(vakjes) .addComponent(veld));
         * layout.setVerticalGroup( layout.createSequentialGroup()
         * .addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
         * .addComponent(algoritme) .addComponent(tijd) .addComponent(vakjes)
         * .addComponent(veld)) );
         */
